<x-layout>
    ...
    <div class="mb-10 mt-10 max-w-2xl p-4 max-lg:mx-auto lg:max-w-6xl">
        <div class="flex flex-col items-start gap-4 lg:flex-row">
            <div class="top-0 w-full lg:sticky">
                <p class="font-medium text-blue-500">We're hiring</p>
                <h5 class="mt-4 font-bold text-gray-900 md:text-2xl">{{ $job['title'] ?? 'Not Specified' }}</h5>
                <div class="mx-auto gap-4">
                    <div class="mt-4 flex items-start text-gray-600">
                        <p class="mr-2">
                    ...
                    <div class="mt-2 flex items-center gap-3">
                        ...
                        <span class="flex items-center gap-1 text-sm text-slate-600">
                            ...
                            {{ isset($job['closing_date'])
                                ? \Carbon\Carbon::parse($job['closing_date'])->format('d
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            M Y')
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    <div x-data="{ open: false }">
                        <button @click="open = true" class="mt-6 rounded bg-purple-900 px-4 py-2 text-white">Apply
                            for
                            this job</button>
                            ...
                            <div class="flex min-h-screen items-center justify-center">
                                <div class="transform overflow-hidden rounded-lg bg-white p-6 shadow-xl transition-all sm:w-full sm:max-w-lg"
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="text-left">
                                            <h3 class="text-lg font-medium leading-6 text-gray-900">Job
                                                Application
                                                Quiz
                                            </h3>
                                            <div class="mt-1">
                                                <p class="text-bold text-gray-500">
                                                    You are about to start application. Please read the
                                                    instructions
                                                    and
                                    ...
                                    <div class="my-2 text-left">
                                        <ol class="list-decimal">
                                            ...
                                            <li>Once question is answered and submited you cannot go back</li>
                                            <li>If you have never uploaded the documents you will be prompted to
                                                upload
                                                first</li>
                                            <li>If you want to update documents you can use the profile page
                                            </li>
                                            <li>Use Of AI or any other assistance is prohibited and can lead to
                                                disqualification</li>
                                    ...
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <a
                                            href="{{ route('checkUserData', ['assessment_id' => $job['assessment_id'], 'job_id' => $job['id']]) }}">
        ...
        <div class="mt-20">
            ...
            <div
                class="mx-auto mb-4 mt-4 grid w-fit grid-cols-1 justify-center justify-items-center gap-6 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($similarJobs['jobs'] as $job)
                    <div class="w-full rounded-xl bg-white shadow-md duration-500 hover:scale-105 hover:shadow-xl">
                        <div
                                ...
                                <div class="mt-2 flex items-center gap-3">
                                    ...
                                    <span class="flex items-center gap-1 text-sm text-slate-600">
                                        <svg width="25px" height="25px" viewBox="0 0 50 50"
                                            ...
                                            <circle fill="#1420cc" cx="10.318" cy="37.806" r="2.411" />
                                            <circle fill="#4430df" cx="10.318" cy="37.806" r="1.411" />
                                            <rect fill="#1e72b3" height="6.446" rx="1.5" width="4.045"
                                                x="35.503" y="5.5" />
                                            <rect fill="#1e72b3" height="6.446" rx="1.5" width="4.045"
                                                x="10.452" y="5.5" />
                                            <path fill="#2479ae"
                            ...
                            <a href="{{ route('posts.show', ['post' => $job['id']]) }}">
                                ...
                                <button class="gap-1 rounded-md bg-purple-900 px-4 py-2 font-medium text-white">
                                    View
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"

<x-layout>
    <form action="{{ route('updatehighesteducationleveldetails') }}" method="post" enctype="multipart/form-data"
        class="mx-auto max-w-3xl px-4 py-12 md:px-8">
        @method('PUT')
        @csrf
        <input type="hidden" name="id" value="{{ $highestEducationLevel['id'] }}">
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="institution" id="institution" autocomplete="institution"
                                    value="{{ old('institution', $highestEducationLevel['institution']) }}"
                                    ...
                                    placeholder="Enter Highest Education Instituion Attended">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="course" id="course" autocomplete="course"
                                    value="{{ old('course', $highestEducationLevel['course']) }}"
                                    class="@error('course') ring-red-500 @enderror block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                    ...
                    <div class="sm:col-span-4">
                        <label for="graduationYear" class="block text-sm font-medium leading-6 text-gray-900">Completion
                            Year</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                ...
                                <input type="text" name="graduationYear" id="graduationYear"
                                    ...
                                    value="{{ old('graduationYear', $highestEducationLevel['graduationYear']) }}"
                                    class="@error('graduationYear') ring-red-500 @enderror block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    placeholder="2001">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="grade" id="grade" autocomplete="grade"
                                    value="{{ old('grade', $highestEducationLevel['grade']) }}"
                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    placeholder="enter grade attained here" @error('grade') ring-red-500 @enderror>
                    ...
                    <div class="col-span-full">
                        <label for="kcseCertificate"
                            class="block text-sm font-medium leading-6 text-gray-900">Certificate</label>
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                    <label for="certificate"
                                        ...
                                        <span>Upload certificate here(optional)</span>
                                        <input id="certificate" name="certificate" type="file"
                                            value="{{ old('certificate') }}"
                                            class="@error('certificate') ring-red-500 @enderror sr-only">
                                    </label>

...
<div class="text-center p-10 ">
    <h1 class="font-bold text-4xl mb-4 ">Available Jobs</h1>
    <h1 class="text-3xl">Tailwind CSS</h1>
</div>

<!-- ✅ Grid Section - Starts Here 👇 -->
<section id="Projects"
    class="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-6 overflow-scroll">

    <!--   ✅ Product card 1 - Starts Here 👇 -->
    <div class="w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <div class=" mx-auto flex flex-row sm:flex-row gap-3 sm:items-center justify-between px-5 py-4 rounded-md">
                   <div>
                       <!-- Job Category -->
                       ...
                       <!-- Job Title -->
                           ...
                           <h3 class="font-bold mt-px">{{ $jobData['title']  ?? 'Not Specified'  }}</h3>
    ...
    <div class="w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <div class=" mx-auto flex flex-row sm:flex-row gap-3 sm:items-center justify-between px-5 py-4 rounded-md">
                   <div>
                       <!-- Job Category -->
                           <span class="text-purple-600 text-sm"> Category</span>
                       ...
                       <div class="flex items-center gap-3 mt-2">
                               ...
                               <span class="bg-purple-100 text-purple-700 rounded-full px-3 py-1 text-sm">Tag</span>

<footer
  class="flex flex-col items-center bg-slate-300 text-center text-surface shadow-dark-mild dark:bg-neutral-700 dark:text-white fixed inset-x-0 bottom-0">
  ...
  {{-- <!--Copyright section-->
  <div class="w-full  bg-slate-300 p-4 text-center">
    © 2024 Copyright:
    <a href="https://tw-elements.com/">Eclectics</a>
  </div> --}}
</footer>